...
-- Server-validated pending authorization requests, keyed by the non-secret
-- WebAuthn challenge id. The one-time claim is a conditional UPDATE; no code or
-- token secret is ever stored here.
